...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_DIRECT_EXTERN_ACCESS;
#else
  int x_TARGET_DIRECT_EXTERN_ACCESS;
#define TARGET_DIRECT_EXTERN_ACCESS global_options.x_TARGET_DIRECT_EXTERN_ACCESS
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_EXPLICIT_RELOCS;
#else
  int x_TARGET_EXPLICIT_RELOCS;
#define TARGET_EXPLICIT_RELOCS global_options.x_TARGET_EXPLICIT_RELOCS
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_mcmodel_ = 1897,                       /* -mcmodel= */
  OPT_mcond_move_float = 1898,               /* -mcond-move-float */
  OPT_mcond_move_int = 1899,                 /* -mcond-move-int */
  OPT_mdirect_extern_access = 1900,          /* -mdirect-extern-access */
  OPT_mdouble_float = 1901,                  /* -mdouble-float */
  OPT_mexplicit_relocs = 1902,               /* -mexplicit-relocs */
  OPT_mfpu_ = 1903,                          /* -mfpu= */
  /* OPT_mfpu_0 = 1904, */                   /* -mfpu=0 */
  /* OPT_mfused_madd = 1905, */              /* -mfused-madd */
  OPT_mglibc = 1906,                         /* -mglibc */
  OPT_mlasx = 1907,                          /* -mlasx */
  OPT_mlsx = 1908,                           /* -mlsx */
  OPT_mmax_inline_memcpy_size_ = 1909,       /* -mmax-inline-memcpy-size= */
  OPT_mmemcpy = 1910,                        /* -mmemcpy */
  OPT_mmemvec_cost_ = 1911,                  /* -mmemvec-cost= */
  OPT_mmusl = 1912,                          /* -mmusl */
  OPT_msimd_ = 1913,                         /* -msimd= */
  OPT_msingle_float = 1914,                  /* -msingle-float */
  OPT_msoft_float = 1915,                    /* -msoft-float */
  OPT_mstrict_align = 1916,                  /* -mstrict-align */
  OPT_mtune_ = 1917,                         /* -mtune= */
  OPT_muclibc = 1918,                        /* -muclibc */
  OPT_n = 1919,                              /* -n */
  OPT_name_sort = 1920,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1921,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1922,              /* -no-integrated-cpp */
  OPT_no_pie = 1923,                         /* -no-pie */
  OPT_nocpp = 1924,                          /* -nocpp */
  OPT_nodefaultlibs = 1925,                  /* -nodefaultlibs */
  OPT_nolibc = 1926,                         /* -nolibc */
  OPT_nophoboslib = 1927,                    /* -nophoboslib */
  OPT_nostartfiles = 1928,                   /* -nostartfiles */
  OPT_nostdinc = 1929,                       /* -nostdinc */
  OPT_nostdinc__ = 1930,                     /* -nostdinc++ */
  OPT_nostdlib = 1931,                       /* -nostdlib */
  OPT_nostdlib__ = 1932,                     /* -nostdlib++ */
  OPT_o = 1933,                              /* -o */
  OPT_objects = 1934,                        /* -objects */
  OPT_p = 1935,                              /* -p */
  OPT_pass_exit_codes = 1936,                /* -pass-exit-codes */
  /* OPT_pedantic = 1937, */                 /* -pedantic */
  OPT_pedantic_errors = 1938,                /* -pedantic-errors */
  OPT_pg = 1939,                             /* -pg */
  OPT_pie = 1940,                            /* -pie */
  OPT_pipe = 1941,                           /* -pipe */
  OPT_posix = 1942,                          /* -posix */
  OPT_print_file_name_ = 1943,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1944,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1945,          /* -print-multi-directory */
  OPT_print_multi_lib = 1946,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1947,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1948,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1949,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1950,               /* -print-prog-name= */
  OPT_print_search_dirs = 1951,              /* -print-search-dirs */
  OPT_print_sysroot = 1952,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1953,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1954,                    /* -print-value */
  OPT_profile = 1955,                        /* -profile */
  OPT_pthread = 1956,                        /* -pthread */
  OPT_quiet = 1957,                          /* -quiet */
  OPT_r = 1958,                              /* -r */
  OPT_rdynamic = 1959,                       /* -rdynamic */
  ...
  OPT_time = 2047,                           /* -time */
  OPT_time_ = 2048,                          /* -time= */
  OPT_tno_android_cc = 2049,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2050,                 /* -tno-android-ld */
