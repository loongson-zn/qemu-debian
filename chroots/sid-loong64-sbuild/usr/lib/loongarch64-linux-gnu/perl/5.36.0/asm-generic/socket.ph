...
unless(defined(&__ASM_GENERIC_SOCKET_H)) {
    ...
    eval 'sub SO_RESERVE_MEM () {73;}' unless defined(&SO_RESERVE_MEM);
    eval 'sub SO_TXREHASH () {74;}' unless defined(&SO_TXREHASH);
    eval 'sub SO_RCVMARK () {75;}' unless defined(&SO_RCVMARK);
