...
unless (defined &_ABILP64) { sub _ABILP64() { 3 } }
...
unless (defined &_LOONGARCH_ARCH) { sub _LOONGARCH_ARCH() { "\"loongarch64\"" } }

unless (defined &_LOONGARCH_ARCH_LOONGARCH64) { sub _LOONGARCH_ARCH_LOONGARCH64() { 1 } }

unless (defined &_LOONGARCH_FPSET) { sub _LOONGARCH_FPSET() { 32 } }

unless (defined &_LOONGARCH_SIM) { sub _LOONGARCH_SIM() { 3 } }

unless (defined &_LOONGARCH_SPFPSET) { sub _LOONGARCH_SPFPSET() { 32 } }

unless (defined &_LOONGARCH_SZINT) { sub _LOONGARCH_SZINT() { 32 } }

unless (defined &_LOONGARCH_SZLONG) { sub _LOONGARCH_SZLONG() { 64 } }

unless (defined &_LOONGARCH_SZPTR) { sub _LOONGARCH_SZPTR() { 64 } }

unless (defined &_LOONGARCH_TUNE) { sub _LOONGARCH_TUNE() { "\"la464\"" } }

unless (defined &_LOONGARCH_TUNE_LA464) { sub _LOONGARCH_TUNE_LA464() { 1 } }
...
unless (defined &__LLACCUM_EPSILON__) { sub __LLACCUM_EPSILON__() { "0x1P\-63LLK" } }

unless (defined &__LLACCUM_FBIT__) { sub __LLACCUM_FBIT__() { 63 } }

unless (defined &__LLACCUM_IBIT__) { sub __LLACCUM_IBIT__() { 64 } }

unless (defined &__LLACCUM_MAX__) { sub __LLACCUM_MAX__() { "0X7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFP\-63LLK" } }

unless (defined &__LLACCUM_MIN__) { sub __LLACCUM_MIN__() { "\-0X1P63LLK\-0X1P63LLK" } }
...
unless (defined &__REGISTER_PREFIX__) { sub __REGISTER_PREFIX__() { "\$" } }
...
unless (defined &__ULLACCUM_EPSILON__) { sub __ULLACCUM_EPSILON__() { "0x1P\-64ULLK" } }

unless (defined &__ULLACCUM_FBIT__) { sub __ULLACCUM_FBIT__() { 64 } }

unless (defined &__ULLACCUM_IBIT__) { sub __ULLACCUM_IBIT__() { 64 } }

unless (defined &__ULLACCUM_MAX__) { sub __ULLACCUM_MAX__() { "0XFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFP\-64ULLK" } }
...
unless (defined &__loongarch64) { sub __loongarch64() { 1 } }

unless (defined &__loongarch__) { sub __loongarch__() { 1 } }

unless (defined &__loongarch_double_float) { sub __loongarch_double_float() { 1 } }

unless (defined &__loongarch_frlen) { sub __loongarch_frlen() { 64 } }

unless (defined &__loongarch_grlen) { sub __loongarch_grlen() { 64 } }

unless (defined &__loongarch_hard_float) { sub __loongarch_hard_float() { 1 } }

unless (defined &__loongarch_lp64) { sub __loongarch_lp64() { 1 } }
